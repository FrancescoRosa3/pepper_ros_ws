...
class Move_head:
    ...
    def move_head(self, request):
        ...
        goal.joint_angles.joint_angles = [request.HeadYaw, request.HeadPith]
        # send goal to server
    ...
    def __init__(self):
        ...
        self.client = actionlib.SimpleActionClient('joint_angles_action', JointAnglesWithSpeedAction)

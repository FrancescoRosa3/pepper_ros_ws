...
(cl:defmethod cl:initialize-instance :after ((m <Say-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Say-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pepper_talk-srv:<Say-request> is deprecated: use pepper_talk-srv:Say-request instead.")))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Say-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pepper_talk-srv:message-val is deprecated.  Use pepper_talk-srv:message instead.")
  (message m))
...
(cl:defmethod cl:initialize-instance :after ((m <Say-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Say-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pepper_talk-srv:<Say-response> is deprecated: use pepper_talk-srv:Say-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Say-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pepper_talk-srv:result-val is deprecated.  Use pepper_talk-srv:result instead.")
  (result m))

...
if("TRUE" STREQUAL "TRUE")
  set(naoqi_sensors_py_SOURCE_PREFIX /home/ciccio/Robotica_Cognitiva/pepper_ros/src/naoqi_bridge/naoqi_sensors_py)
  set(naoqi_sensors_py_DEVEL_PREFIX /home/ciccio/Robotica_Cognitiva/pepper_ros/devel/.private/naoqi_sensors_py)
  ...
  set(naoqi_sensors_py_INSTALL_PREFIX /home/ciccio/Robotica_Cognitiva/pepper_ros/install)
...
if(NOT "/home/ciccio/Robotica_Cognitiva/pepper_ros/devel/.private/naoqi_sensors_py/include " STREQUAL " ")
  set(naoqi_sensors_py_INCLUDE_DIRS "")
  set(_include_dirs "/home/ciccio/Robotica_Cognitiva/pepper_ros/devel/.private/naoqi_sensors_py/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naoqi_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ciccio/Robotica_Cognitiva/pepper_ros/src/naoqi_bridge/naoqi_sensors_py/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT naoqi_sensors_py_NUM_DUMMY_TARGETS)
      set(naoqi_sensors_py_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::naoqi_sensors_py::wrapped-linker-option${naoqi_sensors_py_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR naoqi_sensors_py_NUM_DUMMY_TARGETS "${naoqi_sensors_py_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::naoqi_sensors_py::wrapped-linker-option${naoqi_sensors_py_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND naoqi_sensors_py_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ciccio/Robotica_Cognitiva/pepper_ros/devel/.private/naoqi_sensors_py/lib;/home/ciccio/Robotica_Cognitiva/pepper_ros/devel/lib;/opt/ros/melodic/lib)
